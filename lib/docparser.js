...
YUI.add('docparser', function (Y) {
    ...
    var Lang = Y.Lang,
        ...
        TAGLIST = [
            ...
            'techdebt',     // collects information on actionable items from post-hoc documenters
        ...
        DIGESTERS = {
            ...
            'techdebt': function (tagname, value, target) {
                target.techdebt = true;

                if (typeof value === 'string' && value.length) {
                    target.techdebtMessage = value;
                }
            },
        ...
        processblock: function (block) {
            ...
            if (host) {
                ...
                if (host) {
                    ...
                    if (target.techdebt) {
                        target.attributes.forEach(function (a) {
                            a.techdebt = target.techdebt;

                            if (target.techdebtMessage) {
                                a.techdebtMessage = target.techdebtMessage;
                            }
                        });
                    }
